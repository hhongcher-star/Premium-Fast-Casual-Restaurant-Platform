...
const ORDERS = [
  { id: "MO-58241", date: "Today", items: "Truffle Pasta + Lava Cake", total: 46, status: "Out for delivery" },
  { id: "MO-57993", date: "Mar 12", items: "Harvest Bowl + Salmon", total: 46, status: "Delivered" },
