...
export const dishes: Dish[] = [
  ...
  },
  {
    ...
    description:
      "72-hour fermented dough, San Marzano tomato, fior di latte and Genovese basil.",
    price: 21,
    image: pizza,
    category: "Pizza",
    rating: 4.8,
  ...
  },
  {
    ...
    description:
      "Sustainably sourced salmon, miso-honey glaze, herb oil and seasonal greens.",
    price: 28,
    image: salmon,
    category: "Mains",
    rating: 4.9,
  ...
  },
  {
    ...
    description:
      "Warm 70% chocolate fondant, gold leaf, smoked vanilla cream and wild berries.",
    price: 14,
    image: dessert,
    category: "Desserts",
    rating: 5.0,
